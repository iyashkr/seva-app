    ...
    return (
      <View style={styles.container}>
        <View style={{flexDirection: "row", marginTop: 30, gap: 20, alignItems:"center", marginBottom: 25}}>
          ...
          <Text style={{fontSize: 17, color: "#32343E"}}>Reviews</Text>
        </View>
        <ScrollView showsVerticalScrollIndicator={false}>
            {notifications.map((notification, index) => (
                ...
                <View style={{gap: 2, flex: 4, backgroundColor: "#F6F8FA", marginBottom: 15, paddingTop: 10, paddingBottom: 25, borderRadius: 15, paddingHorizontal: 15}}>
                    ...
                    <Text style={{color: "#32343E", fontSize: 14, fontWeight: 600}}>Great Food and Service</Text>
                    <View style={{flexDirection: "row", marginBottom: 9, marginTop: 5}}><Star/><Star/><Star/><Star/><Star/></View>
                    <Text style={{color: "#9C9BA6", fontSize: 12, fontWeight: 400}}>This Food so tasty & delicious. Breakfast so fast Delivered in my place. Chef is very friendly. I’m really like chef for Home Food Order. Thanks. </Text>
                </View>
